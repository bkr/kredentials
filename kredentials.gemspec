...
Gem::Specification.new do |gem|
  ...
  gem.description   = %q{Gem allows to define config constants for different environments.}
  gem.summary       = %q{Gem allows to define config constants for different environments.}
  gem.homepage      = ""
